...
export const DistributorClientPanel: React.FC = () => {
    // Mock data
    const clients = [
        { id: 1, name: "Marcenaria Silva", plan: "Profissional", status: "Ativo", revenue: "R$ 49,90", commission: "R$ 7,48" },
        { id: 2, name: "Móveis Planejados Souza", plan: "Oficina", status: "Trial", revenue: "R$ 0,00", commission: "R$ 0,00" },
        { id: 3, name: "Arte em Madeira", plan: "Profissional", status: "Inadimplente", revenue: "R$ 49,90", commission: "R$ 0,00" },
    ];
        ...
        <div className="space-y-6 animate-fadeIn">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                <h3 className="text-xl font-bold text-[#b99256] dark:text-[#d4ac6e] flex items-center gap-2">
                    <UsersIcon /> Meus Clientes Indicados
                </h3>
            ...
            <div className="bg-white dark:bg-[#3e3535] rounded-lg border border-[#e6ddcd] dark:border-[#4a4040] overflow-hidden shadow-sm">
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-[#4a4040]">
                            {clients.map(client => (
                                <tr key={client.id} className="hover:bg-gray-50 dark:hover:bg-[#4a4040]/50 transition">
                                    ...
                                    <td className="p-4 text-gray-600 dark:text-gray-300">{client.revenue}</td>
                                    <td className="p-4 font-bold text-green-600 dark:text-green-400">{client.commission}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
                ...
                {clients.length === 0 && (
                    <div className="p-8 text-center text-gray-500">
                        Você ainda não tem clientes indicados. Use seu link de parceiro!
                    </div>
                )}
            </div>
        </div>
