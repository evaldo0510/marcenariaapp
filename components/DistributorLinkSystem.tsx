...
import { LinkIcon, CopyIcon, CheckIcon, QRCodeIcon, ChartBarIcon, ShareIcon } from './Shared';
...
export const DistributorLinkSystem: React.FC = () => {
    ...
    return (
        <div className="space-y-6 animate-fadeIn">
            {/* Elemento com as classes solicitadas */}
            <div className="flex justify-center">
                <div className="flex items-center gap-3 bg-amber-100 p-2 rounded-full shadow-lg animate-pulse-scale">
                    <div className="bg-amber-500 text-white p-1.5 rounded-full">
                        <ShareIcon className="w-4 h-4" />
                    </div>
                    <span className="text-amber-900 text-sm font-bold pr-3">Indique e Ganhe 15% de Comissão</span>
                </div>
            </div>
            ...
            <div className="bg-white dark:bg-[#3e3535] p-6 rounded-xl border border-[#e6ddcd] dark:border-[#4a4040] shadow-sm">
                <h3 className="text-xl font-bold text-[#b99256] dark:text-[#d4ac6e] mb-4 flex items-center gap-2">
                    <LinkIcon /> Seu Link Exclusivo
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">
                    Envie este link para marceneiros. O sistema rastreia automaticamente quem se cadastrar e vincula à sua conta de parceiro.
                </p>
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-gray-200 dark:border-[#4a4040] pt-6">
                    ...
                    <div className="text-center border-l border-gray-200 dark:border-[#4a4040]">
                        <p className="text-xs text-gray-500 uppercase mb-1">Vendas</p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg flex items-start gap-3 border border-blue-100 dark:border-blue-800">
                ...
                <div>
                    <h4 className="font-bold text-blue-800 dark:text-blue-300 text-sm">Dica de Conversão</h4>
                    <p className="text-xs text-blue-700 dark:text-blue-400 mt-1">
                        Parceiros que enviam o link via WhatsApp diretamente para o dono da marcenaria têm 3x mais chances de conversão. Use os scripts na aba de Treinamento.
                    </p>
                </div>
            </div>
            ...
            {showQR && (
                <div className="fixed inset-0 bg-black bg-opacity-80 z-50 flex justify-center items-center p-4 animate-fadeIn" onClick={() => setShowQR(false)}>
                    <div className="bg-white dark:bg-[#3e3535] p-6 rounded-xl shadow-2xl flex flex-col items-center text-center max-w-sm w-full border border-[#e6ddcd] dark:border-[#4a4040]" onClick={e => e.stopPropagation()}>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">Peça para o cliente escanear agora.</p>
